...
//        var CHARGE_DEFAULT = -2500;
        ...
        //number of nodes to precompute graph for
        var NNODES_PRECOMPUTE = 300;
        //default network viz parameters
        var NNODES_DEFAULT = 150;
...
//                    container.append("div").html('<b><i>with ' + ((App.usersinfo)? App.usersinfo[t].name:App.userinfo.name) + '</i></b>');
                ...
                if(App.type != "multi"){
                    ...
                    var tmpstr = "<b>Introduced him/her to:</b><br/><br/>";
            ...
            if(App.type=="multi"){
                ...
                d3.range(App.db.length).forEach(function (t){
                    ...
                    if (App.usersinfo[t]['picture'] !== undefined) {
                        ...
                        panel.select("#userpic").attr("src", "/static/images/" + VMail.App.userinfo.name + ".png");
                    }
                ...
                if (userinfo['picture'] !== undefined) {
                    ...
                    $("#userpic").attr("src", "/static/images/" + VMail.App.userinfo.name + ".png");
                }
        ...
        $(document).ready(function () {
            ...
            if(App.type != "multi"){
                ...
                if (App.userinfo['picture'] !== undefined) {
                    ...
                    $("#user_pic").attr("src", "/static/images/" + VMail.App.userinfo.name + ".png");
                }
                ...
                d3.range(App.usersinfo.length).forEach(function(i){
                    ...
                    if (App.usersinfo[i]['picture'] !== undefined) {
                        ...
                        runway.select("#user_pic").attr("src", "/static/images/" + VMail.App.userinfo.name + ".png");
                    }
                });
            ...
            if(!App.usersinfo){//alert("version"+App.version);
                ...
                d3.json("/static/" + (VMail.App.userinfo.family_name == " "? VMail.App.userinfo.given_name:VMail.App.userinfo.family_name) + "_minimal.json", function(error, data) {
                    allemails = data;
                    App.db = new Array(1);//console.log(data);
                    stats = 0;
