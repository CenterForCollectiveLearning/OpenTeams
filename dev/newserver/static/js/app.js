    ...
    //                            type: "POST",
            ...
            InviteBox.select("#confirm_invite").on("mouseover",function(){
                ...
                for(var ii in App.invitedList){
                    var right_email = App.invitedList[ii].aliases[0];
                    for(var jj in App.invitedList[ii].aliases){
                        if(App.invitedList[ii].aliases[jj].indexOf("gmail") != -1){
                            right_email = App.invitedList[ii].aliases[jj];
                            break;
                        }
                    }
...
//                        name: (VMail.App.userinfo.name),   
                        email: right_email, //(App.invitedList[ii].aliases[App.invitedList[ii].aliases.length-1])
