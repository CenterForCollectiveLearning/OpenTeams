            ...
            $("#searchContacts").autocomplete({
                ...
                source: function (request, response) {
                    ...
                    results.sort(function (a, b) {
                        ...
                        if (idx1 === 0) {
                            if (idx2 === 0) {
                                return getScore((App.db[b.owns].contacts[b.value])) - getScore((App.db[a.owns].contacts[a.value]));
                            } else {
                                return -1;
                            }
                        } else {
...
//                frame();
            ...
            if(member) App.viz.updateMemberNetwork(App.graph);
...
//                  .style("z-index", 100);
        ...
        App.see_members = function (as_yes, as_no){
            if(as_yes){
...
//                    for(var ii = 0; ii < App.graph.nodes.length; ii++){
//                        if(node_id == parseInt(App.graph.nodes[ii].id)){
//                            for(var jj = 0; jj < App.usersinfo.length; jj++){
//                                if(App.graph.nodes[ii].attr.contact.aliases.indexOf(App.usersinfo[jj].email) != -1){
//                                    group_ids.push(node_id);
//                                    return 1;
//                                }
//                            }
//                        }
...
//                d3.selectAll(".link").style("opacity",function(){
//                    var node_id = parseInt(d3.select(this).attr("id"));
//                });
            }
            if(as_no){
        ...
        var showData = function () {
            ...
            var settings = {
                ...
                forceParameters: {
                    ...
                    charge: CHARGE_DEFAULT * (App.member_selected==1? 8.5:1),
                    live: true
                },
